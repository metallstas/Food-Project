...
function calc() {
  ...
  var sex, ratio, height, weight, age;
...
function cards() {
  var Menu = /*#__PURE__*/function () {
    function Menu(img, alt, title, descr, price, parentSelector) {
      _classCallCheck(this, Menu);
      this.img = img, this.alt = alt;
      this.title = title, this.parent = document.querySelector(parentSelector);
      for (var _len = arguments.length, classes = new Array(_len > 6 ? _len - 6 : 0), _key = 6; _key < _len; _key++) {
        classes[_key - 6] = arguments[_key];
      }
      this.descr = descr, this.price = price, this.classes = classes;
    }
...
var openModal = function openModal(modalSelector, modalTimerId) {
  var modalContactUs = document.querySelector(modalSelector);
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  var btnsContactUs = document.querySelectorAll(triggerSelector),
    modalContactUs = document.querySelector(modalSelector);
  btnsContactUs.forEach(function (btn) {
    btn.addEventListener('click', function () {
      return openModal(modalSelector, modalTimerId);
    });
  });
  modalContactUs.addEventListener('click', function (e) {
...
function slider(_ref) {
  var container = _ref.container,
    ...
    field = _ref.field;
  var prev = document.querySelector(prevArrow),
  ...
  var offset = 0;
  var dots = [];
  var getOnlyNum = function getOnlyNum(str) {
  ...
  var counterCurrent = function counterCurrent(index) {
    if (index < 10) {
      currentSlide.textContent = "0".concat(index + 1);
    } else {
...
function timer(id, deadLine) {
  ...
  var setClock = function setClock(selector, endTime) {
    ...
    function updateClock() {
      var total = getTimeRemaning(endTime);
...
/* harmony import */ var _modules_forms_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/forms.js */ "./js/modules/forms.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_tabs_js__WEBPACK_IMPORTED_MODULE_1__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  (0,_modules_timer_js__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2024-10-20');
  ...
  (0,_modules_forms_js__WEBPACK_IMPORTED_MODULE_7__["default"])('form', modalTimerId);
});
/******/ })()
;
