...
window.addEventListener('DOMContentLoaded', () => {
  console.log(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#current'));
  const modalTimerId = setTimeout(() => (0,_modules_modal_js__WEBPACK_IMPORTED_MODULE_3__.openModal)('.modal', modalTimerId), 55000);
